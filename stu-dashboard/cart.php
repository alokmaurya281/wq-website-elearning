...
<section>
                    <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start" style="background-color:white; padding:30px; border-radius:10px; margin-bottom:30px;">
                        <div class="me-auto  d-lg-block">
                            <h2 class="text-black font-w600">Shopping Cart</h2>
...
$category_name = $category['category_name'];
                  ...
                  <div class="pt-5">
                    <h6 class="mb-0"><a href="javascript:history.go(-1)" class="text-body"><i
                          class="fas fa-long-arrow-alt-left me-2"></i>Back to Courses</a></h6>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 bg-grey">
                <div class="p-5">
                  ...
                  <div class="d-flex justify-content-between mb-4">
                    ...
                    <h5>RS. <?php echo $total_price?></h5>
                  </div>

                 

                  <h5 class="text-uppercase mb-3">Coupan code</h5>
                  <?php 
                  $base_url = $_SESSION['base_url'];
                  if(isset($_POST['apply_coupan'])){
                  ...
                  if(!$data['Data']==NULL){
                    ...
                    //   echo $todaydate;
                      ...
                      echo "<script>alert(' coupan Applied. You have Got Flat Rs".$discount_amount." Discount ');</script>";
                      }
                      else{
                          echo "<script>alert(' coupan Expired.');</script>";
                      ...
                      echo "<script>alert('invalid coupan.');</script>";
                  }
                }
...
<form action="" method="post">
                  <div class="mb-5">
                    <div class="form-outline">
                      <input type="text" id="form3Examplea2" name="coupan" value="<?php if(isset($_SERVER['coupan'])){
                          echo $_SERVER['coupan'];
                          }?>" class="form-control form-control-lg" />
                      <label class="form-label" for="form3Examplea2">Enter your code</label>
                      <input type="text" name="total_price" value="<?php echo $total_price?>" hidden>
                      <?php if(isset($_SERVER['coupan']))
                      {?>
                      <button type="button" class="btn btn-dark btn-block btn-lg"
                    data-mdb-ripple-color="dark" disabled>Coupan Applied</button>
                    <?php } 
                        ?>
                        <button type="submit" name="apply_coupan" class="btn btn-primary btn-block btn-lg"
                  ...
                  <div class="d-flex justify-content-between mb-5">
                    ...
                    <h5>Rs. <?php echo $_SERVER['newprice'];?></h5>
                  </div>
                  <?php } 
                        ?>
                  <form action="checkout.php" method="post">
                      <input type="text" name="final_price" value="<?php echo $_SERVER['newprice'];?>" hidden>
                      <input type="text" name="original_price" value="<?php echo $total_price;?>" hidden>
                      <input type="text" name="discount" value="<?php echo $discount_amount;?>" hidden>
                      <input type="text" name="cartid" value="<?php echo $cart_id;?>" hidden>
