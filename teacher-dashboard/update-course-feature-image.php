...
<section>
                    <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start" style="background-color:white; padding:30px; border-radius:10px; margin-bottom:30px;">
                        <div class="me-auto  d-lg-block">
                            <h2 class="text-black font-w600">Upload Course image</h2>
                   ...
                   <form class="form-" action="course_feature_image_update.php" method="post" enctype="multipart/form-data">
                  <!-- 2 column grid layout with text inputs for the first and last names -->
                  <div class="row">
                  <div class="form-outline form-dark mb-4">
                    <input type="text" name="course_id" value="" class="form-control" />
                    <label class="form-label" for="form6Example3">Course Id</label>
                  </div>
      
                  
                  <div class="form-outline mb-4">
                    <label class="form-label" for="customFile">Course Feature Image</label>
                    <input type="file" name="course_feature_image"  class="form-control"  />
                  </div>
