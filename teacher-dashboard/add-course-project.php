  ...
  .active{
    color:#828282!important;
                  ...
                  <div class="text-new">
                      ...
                      <h3>Here You can add projects For Your course</h3>
                      <p>Course Project will create a better impact on every courses it will give the students and learners for getting experience.
                          And Course Projects Must Include a project File if any students want to download or see project and one detailed video about this project must create.
                      </p>
                   ...
                   <form class="form-" action="add-course-project-form.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-outline mb-4">
                    <textarea class="form-control" name="project_long_description" value="" rows="4" required></textarea>
                  ...
                  <div class="form-outline mb-4">
                    <label class="form-label" for="customFile">Course Project File</label>
