...
$data=api_call_post("POST","http://localhost:8000/api/v1/search-by-category", $field);
...
?>
  ...
  <div class="main-h1" style="text-transform:uppercase;">
        <?php echo $keyword?>
  ...
  <?php $data = api_call_get("GET","http://localhost:8000/api/v1/categories" ) ;
            ...
            foreach ($categories as $key => $value) {
              ...
              $x++;
              $category_name= $categories[$x]['category_name'];
            }
            
            
            ?>
    <button class="nav-link active" id="nav-<?php echo $categories[$x]['category_name']?>-tab" data-bs-toggle="tab" data-bs-target="#nav-<?php echo $categories[$x]['category_name']?>" type="button" role="tab" aria-controls="nav-home" aria-selected="true"><?php echo $categories[$x]['category_name']?></button>
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-<?php echo $categories[$x]['category_name']?>" role="tabpanel" aria-labelledby="nav-<?php echo $categories[$i]['category_name']?>-tab"><div class="course-cards blogs " style="margin-top: 20px;">
    <?php $i=-1;
